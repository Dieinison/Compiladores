...
afn = { 0:{ep:set([1,5,12,14,16,19,24,31,38,40,42,44,46,48,50,52,54,56,58,61,64,66,69,72,75,78,81,84]) },
...
';':set([13]), '[':set([13]), ']':set([13]), '(':set([13]), ')':set([13]), '{':set([13]), '}':set([13]), '?':set([13]), 
"'":set([13]), ':':set([13]), '@':set([13]), '\\':set([13]), '.':set([13]), '"':set([13])}, 13:{},
